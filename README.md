...
**Phase 1a v1.4 (current).** Foundation release with field-tested refinements and admin features.
...
4. **Set today's public FX** — click the FX badge, enter USD per EUR (e.g. 1.17) and GBP per EUR (e.g. 0.85). Auto-applied to USD/GBP tickets.
...
ISM and GBM share the same Firebase project. The recommended rules whitelist your team's username:
...
| 2 | AI-driven parser for online sources (Wizz, Ryanair, easyJet, HiSky, FlyOne) — via Anthropic Claude or OpenAI API · Galileo regex parser | planned |

...
**Phase 1a v1.2 (current).** Foundation release with field-tested refinements.
...
- ✅ Inline payment status edit from the ticket list
...
| 5+ | Dedicated client/passenger detail pages with full sortable history; non-air products (hotels, trains, transfers) | parked |
